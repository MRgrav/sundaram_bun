...
export const SkyLinkHeights = async () => {
  ...
  return (
    <Layout
      ...
      keywords="Sundaram Developers, flats in Assam, flats in jorhat, flat in jorhat, buy flat in jorhat, flat, flats, jorhat, Jorhat apartments, smart homes, sky link heights, apartments"
    >
      {/* hero section */}
      ...
      <section class="bg-sky-600 py-16 px-4">
        ...
        <div class="container mx-auto grid md:grid-cols-2 gap-6 my-8">
          <div class="w-full h-[320px] rounded-lg overflow-hidden shadow-lg">
            {/* <iframe src="" class="w-full h-full" style="border:0;" allowfullscreen={true} loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> */}
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3562.8489543750247!2d94.20620411179232!3d26.74919577664811!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3746c3eea2fbd389%3A0x7208d71ee2e8dd57!2sSky%20Link%20Helghts!5e0!3m2!1sen!2sin!4v1768227412537!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen={true} loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
