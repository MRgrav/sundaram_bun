...
export const TopBar = () => (
    <div class={"w-full bg-zinc-900 p-3 text-yellow-200"}>
        <div class={"container mx-auto gap-3 flex items-center justify-between flex-col sm:flex-row text-xs sm:text-md"}>
            ...
            <div class="gap-3 flex flex-col sm:flex-row items-center">
                <a href="tel:+916003948280" class={"flex gap-1 items-center"}>
                    {/* phone icon */}
                    ...
                    <span class={"whitespace-nowrap"}>+91 6003948280</span>
                </a>
                <a href="mailto:developerssundaram@gmail.com" class={"flex gap-1 items-center"}>
                    {/* mail icon */}
                    ...
                    <span>developerssundaram@gmail.com</span>
                </a>
            </div>
        </div>
    </div>
