...
export const AdminLayout = ({
    ...
    <html lang="en">
      <head>
        ...
        <body class="relative bg-linear-to-b from-green-100 to-zinc-200 text-zinc-800 antialiased max-h-screen">
            <div class={"flex h-full overflow-hidden"}>
                <div class={"hidden sm:block min-w-fit p-6"}>
                    ...
                    <div class={"flex flex-col gap-2 h-full "}>
                        ...
                        <div class={"px-4 py-1 rounded-lg hover:bg-white hover:shadow"}>
                            <a href={"/adi/gallery"} class={"flex items-center gap-2 p-2 text-green-900"}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M5 11.1005L7 9.1005L12.5 14.6005L16 11.1005L19 14.1005V5H5V11.1005ZM5 13.9289V19H8.1005L11.0858 16.0147L7 11.9289L5 13.9289ZM10.9289 19H19V16.9289L16 13.9289L10.9289 19ZM4 3H20C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3ZM15.5 10C14.6716 10 14 9.32843 14 8.5C14 7.67157 14.6716 7 15.5 7C16.3284 7 17 7.67157 17 8.5C17 9.32843 16.3284 10 15.5 10Z"></path></svg>
                                <span>Gallery</span>
                            </a>
                        </div>
                        ...
                        <form method="post" action={"/^/logout"}>
                            <button type="submit" class={"px-4 py-1 rounded bg-red-500 text-white shadow"} >Logout</button>
                        </form>
                ...
                <div class={"grow p-4 overflow-auto"}>
                    <div class={"w-full max-h-[90vh] min-w-full overflow-scroll rounded-2xl shadow-lg bg-white"}>
