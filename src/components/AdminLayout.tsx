...
export const AdminLayout = ({
    ...
    <html lang="en">
      <head>
        ...
        <body class="bg-linear-to-b from-green-100 to-zinc-200 text-zinc-800 antialiased">
            <div class={"flex min-h-screen"}>
                <div class={"min-w-fit p-6"}>
                    ...
                    <div class={"flex flex-col gap-2 h-full "}>
                        <div class={"px-4 py-1 rounded-lg hover:bg-white hover:shadow"}>
                            <a href={"/"} class={"flex items-center gap-2 p-2 text-green-900"}>
                        ...
                        <p class="mt-4 border-b border-zinc-400 text-sm">Projects</p>
                        
                        {projects.map((item, index) => (
                        <div class={"px-2 rounded-lg hover:bg-white hover:shadow"} key={index}>
                            <a href={`/adi/projects/${item.path}`} class={"flex items-center gap-2 p-2 text-green-900"}>
                ...
                <div class={"grow p-4"}>
                    <div class={"w-full min-h-[90vh] rounded-2xl shadow-lg bg-white p-6"}>
                        {children}
                    </div>
